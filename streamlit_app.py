...
def main():
        ...
        chart_data = pd.DataFrame(
   {
       ...
       "здравоохранение с инфляцией": df['здравоохранение с инфляцией'],
        ...
        st.write('Красным цветом на каждом графике указан рост зарплат с учетом инфляции. По сравнению с синими графиками наглядно видно, что реальный рост зарплат не всегда был плавным, а главное, зарплаты не всегда действительно росли. Особенно хорошо проседание видно в строительстве в 2009 и 2015 году и здравоохранении в 2021-2022 году.')
